          ...
          <v-row>
            <v-col cols="12" md="4">
              <v-text-field
                ...
                required :rules="formRule.firstName"
              ></v-text-field>
            </v-col>
            <v-col cols="12" md="4">
              <v-text-field
            ...
            <v-col cols="12" md="4">
              <v-text-field v-model="newUser.company" :counter="25"
                            :label="$vuetify.lang.t('$vuetify.company')" :rules="formRule.company"
              ></v-text-field>
            </v-col>
            <v-col cols="12" md="4">
              <v-text-field autocomplete="off" v-model="newUser.email" :rules="formRule.email"
                            :label="$vuetify.lang.t('$vuetify.email')" required>
              </v-text-field>
            </v-col>
            <v-col cols="12" md="4">
              <v-text-field autocomplete="off"
                            v-model="newUser.username"
                            :counter="8" :label="$vuetify.lang.t('$vuetify.username')"
                            required
              ></v-text-field>
            </v-col>
            <v-col cols="12" md="4">
          ...
          <v-row>
            <v-col cols="12" md="4">
              <v-text-field
                ...
                type="password"
                required :rules="formRule.password"
